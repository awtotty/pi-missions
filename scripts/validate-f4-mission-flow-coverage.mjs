...
for (const token of [
	...
	"Confirm scrutiny pass advances to milestone user-testing by default instead of completing the milestone immediately.",
	"Confirm milestone user-testing runs as validator mode `user-testing`",
